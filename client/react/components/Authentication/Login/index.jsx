              ...
              <div className="row" style={{ marginBottom: '150px' }}>
                <div className="col-md-6 offset-md-3 col-12">
                  ...
                  <form autoComplete="off">
                    <div className="my-4">
                      <Input {...this.getFieldProps('email')} addonIcon="envelope" hideLabel className="mc-login-input" name="labels.email" />
                    </div>
                    <div className="my-4">
                      <Input {...this.getFieldProps('password')} type="password" addonIcon="key" hideLabel className="mc-login-input" name="labels.password" />
                    </div>
                    <SubmitButton
                      label="labels.login"
                    ...
                    <Link to={paths.client.REGISTER}>
                      <span className="form-control mc-register-text text-muted">{_t('labels.noAccount')}</span>
                    </Link>
                  </form>
                </div>
              </div>
